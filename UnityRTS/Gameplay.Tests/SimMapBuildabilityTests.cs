...
{
    /// <summary>
    /// Tests for SimMap buildability checks, neighbor ring, walkability,
    /// and prospective build positions.
    /// </summary>
    public class SimMapBuildabilityTests
    {
        // ------------------------------------------------------------------
        // Buildability checks
        // ------------------------------------------------------------------
        ...
        public void GetBuildablePositionsNearUnit_ExcludesOccupied()
        {
            ...
            // Buildable neighbors = only OPEN ring cells (passage cells not included)
