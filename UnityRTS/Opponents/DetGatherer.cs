...
{
    // ============================================================================
    // [DET-SNAPSHOT of Gatherer, frozen 2026-07-12] TEST-ONLY deterministic copy.
    //
    // A faithful, verbatim copy of the competitive Gatherer agent, included ONLY in the
    // parity test set so cross-engine parity runs on a real, long, engine-exercising
    // game. Gatherer was already fully deterministic (no RNG, no Dictionary/HashSet
    ...
    //
    // FROZEN: this is a point-in-time snapshot, NOT maintained in lockstep with Gatherer.
    // The competitive Gatherer may later change or gain intentional non-determinism; this
    // copy intentionally stays as it was on 2026-07-12. Do not "sync" it. Built to
    // EnemyAgents/PlanningAgent_DetGatherer.dll.
    // ============================================================================
    /// <summary>
