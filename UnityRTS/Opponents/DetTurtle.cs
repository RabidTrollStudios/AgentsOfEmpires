...
{
    // ============================================================================
    // [DET-SNAPSHOT of Turtle, frozen 2026-07-12] TEST-ONLY deterministic copy.
    //
    // A faithful, verbatim copy of the competitive Turtle agent for the parity test set
    // (real, long, engine-exercising games). Turtle uses Dictionary/HashSet, but every
    ...
    //
    // FROZEN snapshot, NOT maintained in lockstep with Turtle. Built to
    // EnemyAgents/PlanningAgent_DetTurtle.dll.
    // ============================================================================
    /// <summary>
