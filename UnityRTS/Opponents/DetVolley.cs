...
{
    // ============================================================================
    // [DET-SNAPSHOT of Volley, frozen 2026-07-12] TEST-ONLY deterministic copy.
    //
    // A faithful, verbatim copy of the competitive Volley agent for the parity test set
    // (real, long, engine-exercising games). Volley uses Dictionary/HashSet, but every
    ...
    //
    // FROZEN snapshot, NOT maintained in lockstep with Volley. Built to
    // EnemyAgents/PlanningAgent_DetVolley.dll.
    // ============================================================================
    /// <summary>
    ...
    public class PlanningAgent : PlanningAgentBase
    {
        ...
        private void EvaluateArcherTactics(IGameState state, Position rallyPoint)
        {
            ...
            foreach (int archerNbr in myArchers)
            {
                ...
                foreach (UnitType ut in new[] { UnitType.ARCHER, UnitType.LANCER, UnitType.PAWN,
