...
{
    // ============================================================================
    // [DET-SNAPSHOT of WarriorRush, frozen 2026-07-12] TEST-ONLY deterministic copy.
    //
    // A faithful, verbatim copy of the competitive WarriorRush agent, included ONLY in the
    // parity test set so cross-engine parity runs on a real, long, engine-exercising
    // game. WarriorRush was already fully deterministic (no RNG, no Dictionary/HashSet
    ...
    //
    // FROZEN: this is a point-in-time snapshot, NOT maintained in lockstep with WarriorRush.
    // The competitive WarriorRush may later change or gain intentional non-determinism; this
    // copy intentionally stays as it was on 2026-07-12. Do not "sync" it. Built to
    // EnemyAgents/PlanningAgent_DetWarriorRush.dll.
    // ============================================================================
    /// <summary>
    /// [MEDIUM] Minimal economy, fast barracks, warrior rush with 3+.
    /// Punishes slow builders — runs out of gold quickly if the rush fails.
    /// </summary>
