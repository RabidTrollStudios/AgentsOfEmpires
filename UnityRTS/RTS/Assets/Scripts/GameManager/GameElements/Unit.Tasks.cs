...
{
	/// <summary>
	/// Unit partial — visual effect spawners (arrows, gold nuggets, heal VFX).
	///
	/// Game logic (attack/build/gather/train/repair/heal advancement) lives in the
	/// shared AgentSDK.TickEngine. The former per-frame Update* task methods here were
	/// a dead second copy of that engine and have been removed. Only the genuinely
	/// visual helpers below remain — they are invoked by Unit.Movement/Unit.VisualState
	/// and UnityTickCallbacks in response to TickEngine events.
	/// </summary>
