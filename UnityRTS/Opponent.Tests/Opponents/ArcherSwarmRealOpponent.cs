...
{
    /// <summary>
    /// [HARD] Relentless archer aggression: 4 pawns, archery, then
    /// constantly produces archers and attacks immediately with each one.
    /// Mirrors Swarm's warrior behavior but with archers.
    /// Tests whether trickle archer pressure with range (9.0) is stronger
    /// than trickle warrior pressure.
    /// Strategy to beat: warriors counter archers (1.25x), or out-economy
    /// the constant spending on fragile 80g units.
    /// </summary>
    public class ArcherSwarmRealOpponent : PlanningAgentBase
    {
        ...
        public override void Update(IGameState state, IAgentActions actions)
        {
            ...
            // Attack immediately — send every idle archer
