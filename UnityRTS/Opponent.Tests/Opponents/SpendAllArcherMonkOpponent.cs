...
{
    /// <summary>
    /// [HARD] Max-spend Archer + Monk: 6 pawns, Archery + Monastery.
    ...
    /// Tests whether archer range (9.0) combined with constant monk healing
    /// creates a cost-efficient sustain wall under max-spend pressure.
    /// Strategy to beat: warriors counter archers (1.25x); rush before
    /// both buildings complete (350g + 350g = 700g investment).
    /// </summary>
    public class SpendAllArcherMonkOpponent : PlanningAgentBase
    {
        ...
        public override void Update(IGameState state, IAgentActions actions)
        {
            ...
            // Build order: archery first, then monastery
            ...
            // Attack with archers when total combat army is large enough
