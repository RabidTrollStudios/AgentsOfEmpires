...
{
    /// <summary>
    /// [HARD] Max-spend Archer + Lancer + Monk: 6 pawns, Archery + Tower + Monastery.
    /// Trains Archers from Archery, Lancers from Tower, and Monks from Monastery
    ...
    /// Attacks with all archers and lancers when total combat army reaches 6+ combined.
    /// Tests whether archer range combined with lancer speed and monk sustain
    /// creates an overwhelming front-to-back force under three production buildings.
    /// Strategy to beat: warriors counter archers (1.25x); rush before all three
    /// buildings complete (350g + 400g + 350g = 1100g investment).
    /// </summary>
    public class SpendAllArcherLancerMonkOpponent : PlanningAgentBase
    {
        ...
        public override void Update(IGameState state, IAgentActions actions)
        {
            ...
            // Build order: archery -> tower -> monastery
            ...
            // Attack with archers and lancers when total combat army is large enough
