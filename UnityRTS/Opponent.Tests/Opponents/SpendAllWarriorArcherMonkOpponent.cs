...
{
    /// <summary>
    /// [HARD] Max-spend Warrior + Archer + Monk: 6 pawns, Barracks + Archery + Monastery.
    /// Trains Warriors from Barracks, Archers from Archery, and Monks from Monastery
    ...
    /// Attacks with all warriors and archers when total combat army reaches 6+ combined.
    /// Tests whether warrior/archer combined pressure with monk sustain overwhelms
    /// opponents under three simultaneous production buildings.
    /// Strategy to beat: lancers counter warriors (1.25x); rush before all three
    /// buildings complete (400g + 350g + 350g = 1100g investment).
    /// </summary>
    public class SpendAllWarriorArcherMonkOpponent : PlanningAgentBase
    {
        ...
        public override void Update(IGameState state, IAgentActions actions)
        {
            ...
            // Build order: barracks -> archery -> monastery
            ...
            // Attack with warriors and archers when total combat army is large enough
