...
{
    /// <summary>
    /// [HARD] Greedy economy archer flood: 10 pawns, archery, floods archers.
    /// Attacks with 6+ archers. Mirrors EconBoom but with archers.
    /// Tests whether a massive pawn economy into cheap archers (80g)
    /// overwhelms opponents with volume and range.
    /// Strategy to beat: rush before the economy saturates, or warriors
    /// counter archers (1.25x).
    /// </summary>
    public class ArcherEconBoomOpponent : PlanningAgentBase
    {
