...
{
    /// <summary>
    /// [HARD] Archer + Monk sustain: 5 pawns, Archery + Monastery.
    /// Trains archers (2/3) and monks (1/3). Monks heal most-wounded
    /// archer below 80% HP. Attacks with 4+ archers.
    /// Tests whether monk healing extends archer survivability enough
    /// to overcome their low HP (600). Archers' range (9.0) should
    /// keep them alive longer, making each heal more valuable.
    /// Strategy to beat: warriors counter archers (1.25x) and can
    /// close distance to snipe monks, or lancers with speed.
    /// </summary>
    public class ArcherMonkOpponent : PlanningAgentBase
    {
        ...
        public override void Update(IGameState state, IAgentActions actions)
        {
            ...
            // Build archery first, then monastery
            ...
            // Train monks from monastery (every 3rd cycle, prefer archers)
            ...
            // Monks heal most-wounded archer
            HealWithMonks(state, actions);

            // Attack with archers when threshold reached
