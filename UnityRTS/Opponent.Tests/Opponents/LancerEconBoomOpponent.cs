...
{
    /// <summary>
    /// [HARD] Greedy economy lancer flood: 10 pawns, tower, floods lancers.
    /// Attacks with 6+ lancers. Mirrors EconBoom but with lancers.
    /// Tests whether a massive pawn economy into lancers (90g) with
    /// speed (2.8x) and warrior-counter (1.25x) overwhelms opponents.
    /// Strategy to beat: rush before the economy saturates, or archers
    /// counter lancers (1.25x).
    /// </summary>
    public class LancerEconBoomOpponent : PlanningAgentBase
    {
