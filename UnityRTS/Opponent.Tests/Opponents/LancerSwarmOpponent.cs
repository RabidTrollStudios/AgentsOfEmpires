...
{
    /// <summary>
    /// [HARD] Relentless lancer aggression: 4 pawns, tower, then
    /// constantly produces lancers and attacks immediately with each one.
    /// Mirrors Swarm's warrior behavior but with lancers.
    /// Tests whether trickle lancer pressure with speed (2.8x) and
    /// warrior-counter (1.25x) is effective as a swarm strategy.
    /// Strategy to beat: archers counter lancers (1.25x), or mass
    /// warriors to tank the individual lancers.
    /// </summary>
    public class LancerSwarmOpponent : PlanningAgentBase
    {
        ...
        public override void Update(IGameState state, IAgentActions actions)
        {
            ...
            // Attack immediately — send every idle lancer
