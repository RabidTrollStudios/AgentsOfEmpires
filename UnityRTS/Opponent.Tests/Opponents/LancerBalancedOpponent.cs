...
{
    /// <summary>
    /// [MEDIUM] Solid lancer economy: 5 pawns, tower, masses lancers.
    /// Attacks with 5+ lancers. Mirrors Balanced/Commander pattern
    /// but with Tower → Lancers instead of Barracks → Warriors.
    /// Tests mid-game lancer viability with a standard economy.
    /// Strategy to beat: archers counter lancers (1.25x), or rush
    /// before the lancer army reaches critical mass.
    /// </summary>
    public class LancerBalancedOpponent : PlanningAgentBase
    {
